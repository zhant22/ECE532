...
HD_PWD='C:/Users/10695/Desktop/proj5/proj5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lwip_server_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lwip_server_wrapper.tcl -notrace
