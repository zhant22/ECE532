...
HD_PWD='C:/Users/owner/proj5/proj5.runs/bd_98b9_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_98b9_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_98b9_util_vector_logic_0_0.tcl
