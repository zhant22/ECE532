...
HD_PWD='C:/Users/owner/ECE532/_archive_proj5_update2.xpr/proj5/proj5.runs/lwip_server_axi_gpio_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lwip_server_axi_gpio_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lwip_server_axi_gpio_2_0.tcl
