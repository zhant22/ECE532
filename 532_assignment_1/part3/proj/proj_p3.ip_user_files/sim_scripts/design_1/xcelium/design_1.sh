...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../proj_p3.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../proj_p3.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"F:/Vivado/2018.3/data/xilinx_vip/include"
}
