...
xvlog_opts="--relax -L axi_vip_v1_1_4 -L xilinx_vip"
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="F:/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
