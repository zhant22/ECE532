...
//Constants
//AXI mask532 base address and register offsets
//following lab manual 
localparam mask532_n_OFFSET = 'h0;
localparam mask532_valuein_OFFSET = 'h4;
localparam mask532_outputaddr_OFFSET = 'h8;
localparam mask532_initwrite_OFFSET = 'hC;

localparam mask532_BASE_ADDRESS = 'h0004_0000;
localparam BRAM_BASE_ADDRESS = 'h0000_0000;
  initial begin
    /***********************************************************************************************
    ...
    ***********************************************************************************************/
    ...
    //test1 is the eaxmple in lab manual 
    $write("---TEST1 begin ---\n");
    $write("n_value=12, value_in=0x01234567 \n");
    writeRegister(mask532_BASE_ADDRESS + mask532_n_OFFSET, 'd5);
    writeRegister(mask532_BASE_ADDRESS + mask532_valuein_OFFSET, 'h01234567);
    writeRegister(mask532_BASE_ADDRESS + mask532_outputaddr_OFFSET, BRAM_BASE_ADDRESS);
    writeRegister(mask532_BASE_ADDRESS + mask532_initwrite_OFFSET, 'h1);
    // Wait for all writes to complete
    agent.wait_drivers_idle();
    // read from BRAM
    $write("Masked value from BRAM \n");
    agent.wait_drivers_idle();
    readRegister(BRAM_BASE_ADDRESS, Rdatabeat);
    $write("BRAM value: 0x%08x\n", Rdatabeat[0]);
    
    
    //$write("BRAM value: 0xfff34567\n"); 
    //-------------------------------
    
    $write("---TEST2 begin ---\n");
    $write("n_value=8, value_in=0x00000001 \n");
    writeRegister(mask532_BASE_ADDRESS + mask532_n_OFFSET, 'd8);
    writeRegister(mask532_BASE_ADDRESS + mask532_valuein_OFFSET, 'h0000_0001);
    writeRegister(mask532_BASE_ADDRESS + mask532_outputaddr_OFFSET, BRAM_BASE_ADDRESS);
    writeRegister(mask532_BASE_ADDRESS + mask532_initwrite_OFFSET, 'h1);
    //Wait for all writes to complete
    agent.wait_drivers_idle();   
    ...
    $write("BRAM value: 0xff000001\n");
 
    $write("---TEST2 begin ---\n");
    $write("n_value=31, value_in=0x00000001 \n");
    writeRegister(mask532_BASE_ADDRESS + mask532_n_OFFSET, 'd31);
    writeRegister(mask532_BASE_ADDRESS + mask532_valuein_OFFSET, 'h0000_0001);
    writeRegister(mask532_BASE_ADDRESS + mask532_outputaddr_OFFSET, BRAM_BASE_ADDRESS);
    writeRegister(mask532_BASE_ADDRESS + mask532_initwrite_OFFSET, 'h1);
    //Wait for all writes to complete
...
module part3_tb();
	...
	design_1_wrapper DUT(.clk(aclk), .resetn(aresetn));
