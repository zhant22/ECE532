...
HD_PWD='C:/Users/10695/Desktop/proj5/proj5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lwip_server_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lwip_server_wrapper.tcl
