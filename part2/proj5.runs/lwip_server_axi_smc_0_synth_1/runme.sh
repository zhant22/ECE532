...
HD_PWD='C:/Users/owner/proj5/proj5.runs/lwip_server_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lwip_server_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lwip_server_axi_smc_0.tcl
