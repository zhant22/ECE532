...
################################################################
# This is a generated script based on design: lwip_server
#
...
proc create_root_design { parentCell } {
  ...
  set but_5b [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 but_5b ]
  ...
  set led_8b [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 led_8b ]
  set sw_8b [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 sw_8b ]
  ...
  # Create instance: axi_gpio_button, and set properties
  set axi_gpio_button [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_button ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_gpio_button_GPIO [get_bd_intf_ports but_5b] [get_bd_intf_pins axi_gpio_button/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_led_GPIO [get_bd_intf_ports led_8b] [get_bd_intf_pins axi_gpio_led/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_sw_GPIO [get_bd_intf_ports sw_8b] [get_bd_intf_pins axi_gpio_sw/GPIO]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_0_axi_periph_M04_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins axi_gpio_sw/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins axi_gpio_led/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_button/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_button/S_AXI/Reg] SEG_axi_gpio_button_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_gpio_button/S_AXI/Reg] SEG_axi_gpio_button_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_gpio_led/S_AXI/Reg] SEG_axi_gpio_led_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_gpio_sw/S_AXI/Reg] SEG_axi_gpio_sw_Reg
